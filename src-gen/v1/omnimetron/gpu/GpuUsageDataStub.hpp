...
*/
#ifndef V1_OMNIMETRON_GPU_Gpu_Usage_Data_STUB_HPP_
#define V1_OMNIMETRON_GPU_Gpu_Usage_Data_STUB_HPP_
...
public:
    ...
    typedef ::v1::omnimetron::gpu::GpuUsageData StubInterface;
};
...
#endif // V1_OMNIMETRON_GPU_Gpu_Usage_Data_STUB_HPP_
