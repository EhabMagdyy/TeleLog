 ...
 */
#ifndef V1_OMNIMETRON_GPU_GPU_USAGE_DATA_SOMEIP_PROXY_HPP_
#define V1_OMNIMETRON_GPU_GPU_USAGE_DATA_SOMEIP_PROXY_HPP_
...
#endif // V1_OMNIMETRON_GPU_Gpu_Usage_Data_SOMEIP_PROXY_HPP_
